      ...
      <div className="w-full max-w-md">
        <div className="bg-white border-4 border-[#1a1a1a] rounded-xl p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="text-gray-600 text-center mb-8">
            Ready to continue your masterpiece?
          </p>

          <form action={action} className="space-y-6">
            {state?.error && (
              <div className="text-red-500 text-center font-bold">{state.error}</div>
            )}
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-4 bg-[#1a1a1a] text-white text-xl font-bold rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all disabled:opacity-50"
            >
          ...
          <div className="mt-8 text-center text-gray-600">
            ...
            <Link
              href="/signup"
              className="font-bold text-[#1a1a1a] hover:underline decoration-2 underline-offset-4"
            >
              Sign up
            </Link>
          </div>
